...
public class action0 implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		if(arg0.getSource()==main.w.exit){
			...
			main.w.p2d.gridWeight=Integer.parseInt(javax.swing.JOptionPane.showInputDialog(null, "长度"));
			main.w.p2d.gridHeight=Integer.parseInt(javax.swing.JOptionPane.showInputDialog(null, "高度"));
			main.w.p2d.setSize(main.w.p2d.panelWeight*main.w.p2d.gridWeight+1, main.w.p2d.panelHeight*main.w.p2d.gridHeight+1);
			main.w.p2d.repaint();
		}
	}
