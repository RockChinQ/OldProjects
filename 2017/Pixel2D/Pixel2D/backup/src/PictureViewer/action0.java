	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getSource()==main.w.open){
			try{
				...
				//System.out.println(main.w.p2d.panelWeight);
				main.w.p2d.drawByCode(0, 0, null,code);
				main.w.g.setSize(main.w.jsl.getValue()*main.w.p2d.panelWeight+41,main.w.jsl.getValue()*main.w.p2d.panelHeight+111);
				main.w.g.setCenter();
			}catch(Exception e){
